...
#define SPI_POSTAMBLE_B 0xb  // unused
#define SPI_SECTPERTRK_C 0xc  // unused
#define SPI_BITCLKDIV_CP_D 0xd  // unused
#define SPI_BITCLKDIV_DP_E 0xe  // unused
#define SPI_BITPLSWIDTH_F 0xf  // unused
#define SPI_RESET_CYLINDER_10 0x10
#define SPI_USECPERSECTH_10 0x10   // unused
#define SPI_USECPERSECTL_11 0x11  // unused
#define SPI_SERVO_PW_12 0x12
#define SPI_INTERFACE_TEST_MODE_20 0x20

//FPGA CPU REGISTERS, READ
#define SPI_STATUS_80 0x80  // unused
#define SPI_CYLADDR_81 0x81
#define SPI_DRVSTATUS_82 0x82
#define SPI_DRVSTATUS_83 0x83
#define SPI_DRAMREAD_88 0x88
#define SPI_FUNCT_ID_89 0x89     // unused
#define SPI_FPGACODE_VER_90 0x90
#define SPI_FPGACODE_MINORVER_91 0x91
#define SPI_TEST_MODE_GRP1_94 0x94  // unused
#define SPI_TEST_MODE_GRP2_95 0x95  // unused
#define SPI_TEST_MODE_GRP3_96 0x96  // unused
#define SPI_READBACK_00_A0 0xa0
#define SPI_READBACK_00_A7 0xa7  // not used
#define SPI_READBACK_00_A8 0xa8  // unused
#define SPI_READBACK_00_A9 0xa9  // unused
#define SPI_READBACK_00_AA 0xaa  // unused
#define SPI_READBACK_00_AB 0xab  // unused
#define SPI_READBACK_00_AC 0xac  // unused
#define SPI_READBACK_00_AD 0xad  // unused
#define SPI_READBACK_00_AE 0xae  // unused
#define SPI_READBACK_00_AF 0xaf  // unused
#define SPI_READBACK_00_B0 0xb0  // unused
#define SPI_READBACK_00_B1 0xb1  // unused
...
void set_cpu_rdy_indicator()
{
    ...
    // also turn off reset flag so cylinder can advance from 0
    write_spi_register(SPI_RESET_CYLINDER_10, 0x00);
}

void clear_cpu_rdy_indicator()
{
    gpio_put(FP_CPU_RDY_ind, GPIO_ON);
    // also turn on reset flag to force cylinder to 0
    write_spi_register(SPI_RESET_CYLINDER_10, 0xFF);
}

void clear_cpu_rdy_indicator_only()
{
    gpio_put(FP_CPU_RDY_ind, GPIO_ON);
}
